...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '知識轉述師', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '聲聲相伴', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion-next-1l2g.vercel.app/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion', // 网站关键词 英文逗号隔开
  ...
  POST_RECOMMEND_COUNT: 12, // 推荐文章数量
